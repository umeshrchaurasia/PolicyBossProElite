...
public class Good_OfflineMotorListActivity extends BaseActivity implements View.OnClickListener, IResponseSubcriber {
    ...
    Good_OfflineMotorListItemAdapter mAdapter;
    boolean isHit = false;
    ...
    public void OnSuccess(APIResponse response, String message) {
        ...
        if (response instanceof OfflineMotorListResponse) {
            ...
            mAdapter = new Good_OfflineMotorListItemAdapter(this, listMotorListEntity);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.fbOfflineMotor) {
            startActivity(new Intent(this, Good_InputOfflineMotorActivity.class));
        }
    }
