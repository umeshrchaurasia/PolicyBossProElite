...
public class Good_OfflineMotorListItemAdapter extends RecyclerView.Adapter<Good_OfflineMotorListItemAdapter.OfflineMotorItem> {

    Activity mcontext;
    List<OfflineMotorListEntity> offlineMotorList;

    public Good_OfflineMotorListItemAdapter(Activity mcontext, List<OfflineMotorListEntity> documentsOfflineList) {
